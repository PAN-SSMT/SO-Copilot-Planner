    ...
    <div className="relative space-y-4">
      <section className="relative rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="absolute bottom-4 right-4">
          <AIIndicatorCard
            id="ai-9"
            text="AI-explained in production. The model would generate a natural language explanation of why each risk was flagged, including trend data and what specifically changed. Currently the trigger rules are template-based with variable substitution."
          />
        </div>
      </section>
      ...
      <FeatureDiscoveryHint
        id="fdh-4"
        pageKey="alerts"
        text="Expand 'Why this alert?' on any risk card to see the exact rule and threshold that triggered it. Try switching between 'Grouped by Customer' and 'Sorted by Severity' view modes."
      />
      ...
      <div className="relative">
        ...
        <div className="absolute right-4 top-2">
          <SectionCallout
            id="sc-6"
            text="The portfolio risk engine. Every alert is generated by a rule applied to customer data — cadence gaps, LoE overruns, stale assessments, renewal proximity, product blockers. Expand 'Why this alert?' on any card to see the exact trigger logic and threshold."
          />
        </div>
      </div>
    </div>
